...
export function Footer({
  ...
  return (
    <footer className="w-full border-t border-white/10 bg-surface/70 px-6 py-6 text-xs text-slate-400">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 lg:flex-row lg:justify-between">
        {/* Left Column - Branding */}
        <div className="space-y-3">
          <div>
            <h3 className="mb-2 text-sm font-semibold text-white">{siteConfig.brandName}</h3>
              ...
              <div className="flex gap-2">
                {siteConfig.social.facebook && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-full border border-white/20 bg-white/5 p-2 text-white/80 hover:border-primary hover:text-primary transition-colors"
                    aria-label="Facebook"
                  >
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button onClick={onContactUs} className="text-left text-white/80 hover:text-white">
              Contact Us
            </button>
            {onAboutUs && (
              <button onClick={onAboutUs} className="text-left text-white/80 hover:text-white">
                About Us
              </button>
            )}
            {onShippingReturns && (
        ...
        <div className="space-y-3">
          ...
          {featureFlags.enableNewsletter && (
            <div className="mt-4 space-y-2">
              ...
              <p className="text-xs text-slate-400">Get updates on new products and special offers</p>
